...
// and return it.
func mapPath(prefix string, path string, v reflect.Value, settings *PathSettings) Pathor {
	p := prefix + "." + strconv.Quote(path)
...
func structPath(prefix string, path string, v reflect.Value, pv *reflect.Value, settings *PathSettings) Pathor {
	p := prefix + "." + path
